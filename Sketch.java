  ...
  public void draw_section2(){
    ...
    for(int intRow = 0; intRow < 30; intRow++){
      for(int intColumn = 0; intColumn < 30; intColumn++){
        ...
        // Switch the fill color between black and white every other column starting with white
        fill(0);
        if (intRow % 2 == 0){
          fill(255);
        }
  ...
  public void draw_section3(){
    ...
    for(int intRow = 0; intRow < 30; intRow++){
      for(int intColumn = 0; intColumn < 30; intColumn++){
        ...
        // Switch the fill color between black and white every other row starting with black
        fill(0);
        if (intColumn % 2 == 1){
          fill(255);
        }
  ...
  public void draw_section4(){
    ...
    for(int intRow = 0; intRow < 30; intRow++){
      for(int intColumn = 0; intColumn < 30; intColumn++){
        ...
        // Switch the fill color to white only on odd rows and even columns
        fill(0);
